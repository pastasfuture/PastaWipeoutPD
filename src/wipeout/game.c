...
// 	input_bind(INPUT_LAYER_SYSTEM, INPUT_GAMEPAD_START, A_MENU_START);
	...
	g.circut = CIRCUT_ALTIMA_VII;//CIRCUT_TERRAMAX;
	g.race_class = RACE_CLASS_VENOM;//RACE_CLASS_RAPIER;
	g.race_type = RACE_TYPE_SINGLE;// RACE_TYPE_TIME_TRIAL; // RACE_TYPE_SINGLE; RACE_TYPE_TIME_TRIAL
	g.is_attract_mode = false;//true;
